...
export default function WaitingListForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const utmData = getUTMData();
      const pageLeadSource = utmData && utmData.utm_source ? utmData.utm_source : 'Direct Mail';
      ...
      const response = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          id: 'directmail-form', // Form identifier
          fields: JSON.stringify(formData), // Salesforce fields
          form_title: 'directmail', // Form title for tracking
          utm_data: JSON.stringify(utmData), // UTM tracking data
          page_lead_source: pageLeadSource, // utmData.utm_source || hardcoded string
          page_campaign_id: '', // No specific campaign for directmail page
          form_source: 'directmail', // Specific form source identifier
        }),
      });
